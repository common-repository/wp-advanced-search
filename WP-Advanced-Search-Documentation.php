    ...
    <div class="block clear">
        <div class="col">
        	<p class="tr">
                ...
                <br/>
                <?php _e('&nbsp;&nbsp;&nbsp;&nbsp;Ajouter le code <strong>&lt;?php WP_Advanced_Search(); ?&gt;</strong> pour afficher les résultats ou ajoutez le shortcode [advanced-search] à l\'endroit désiré dans votre site','wp-advanced-search'); ?>
            </p>
            <div class="tr-info">
                <p><?php _e('Code : installation simple et rapide !','wp-advanced-search') ?></p>
                <ol>
            	...
            	<p><?php _e('Shortcode : installation très simple !','wp-advanced-search') ?></p>
                <ol>
                    <li><?php _e('Copiez le shortcode [advanced-search] dans une page (en général, les résultats se positionnent en haut de page automatiquement).','wp-advanced-search') ?></li>
                </ol>
            </div>
        </div>
        <div class="col">
